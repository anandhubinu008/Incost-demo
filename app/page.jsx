  ...
  return (
    <main className="w-full relative items-center flex px-15 justify-center items-center bg-no-repeat bg-cover h-[100dvh] ">
      <div className='z-20'>
        ...
        <div className='mt-4 text-xl lg:w-[50%]'>
      ...
      <div className="absolute  z-10 lg:w-[50%] bg-cover h-full right-0 top-0 bg-[url('https://images.pexels.com/photos/1571458/pexels-photo-1571458.jpeg?cs=srgb&dl=pexels-fotoaibe-1571458.jpg&fm=jpg')]">
